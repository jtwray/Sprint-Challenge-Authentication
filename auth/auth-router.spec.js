...
describe('auth-router', () => {
    ...
    describe('.post(/register', () => {
        it('should add provided user into the db on registration', async () => {
            ...
            expect(newUser).toHaveProperty('text',['userId','username','token']);
            expect(newUser).toContain('text'||'userId','username','token');
    ...
    describe('server.js', () => {
        ...
        describe('register', () => {
            ...
            it('should return a JSON object with DATA from the register route', async () => {
                ...
                expect(response).toContainEqual('header,text',['username','userId','token']); //-----DATA-----post/api/auth/login
                expect(response).toHaveProperty('body',['username','userId','token']); //-----DATA-----post/api/auth/login
                // expect(response.body).toContain('username' && 'userId' && 'token'); //-----DATA-----post/api/auth/login
            });
